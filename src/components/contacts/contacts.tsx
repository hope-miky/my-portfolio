...
const ContactsPageView = () => {
    ...
    return <div className=" first-screen pb-36 w-screen main-bg sm:mt-24" id="contactspage" >
            ...
            <button className="mt-5 ml-12 text-bold text-white font-sans text-4xl sm:text-5xl land2"> <span className="text-teal-400 font-bold mr-2">010.</span> Contacts </button>
            ...
            <div className=" flex flex-wrap justify-center mt-24 ">
                <div className="flex flex-col justify-center w-full sm:w-1/4  mx-12 mb-10 ">
                    <div className="text-white text-xl"> Osiedle Stare Żegrze 173 </div>
                ...
                <div className="flex flex-col justify-center sm:w-1/3 mx-5 ">
                    <div className=" text-center mb-5 text-2xl text-gray-400"> I am not actively looking for a new role but I am always open for discussion :) </div>
