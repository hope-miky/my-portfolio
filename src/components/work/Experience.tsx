...
const ExperiencePageView = () => {
    ...
    return <div className=" first-screen sm:h-screen pb-36  main-bg" id="experiencepage" >
            ...
            <button className="mt-5 ml-12 text-bold text-white font-sans text-4xl sm:text-5xl land2"> <span className="text-teal-400 font-bold mr-2">010.</span> Experience </button>
                ...
                <div className="flex flex-wrap justify-center ">
                    {
                        work_data.map((work: any, idx: number) => {
                            return <div key={idx} className=" m-12 w-full sm:w-auto">
